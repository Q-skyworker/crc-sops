...
APP_ID = 'cmp-hospital'
APP_TOKEN = '24139779-03c8-4ddf-8154-77372eaa0f31'
...
if IS_USE_CELERY:
    try:
        ...
        pass
    from pipeline.engine.celery.settings import *
...
DEBUG_TOOLBAR_RUN_MODE = []

if RUN_MODE in DEBUG_TOOLBAR_RUN_MODE:

    def show_toolbar_callback(request):
        if RUN_MODE not in DEBUG_TOOLBAR_RUN_MODE:
            return False

        # if not request.user.is_superuser:
        #     return False

        if request.path.startswith(SITE_URL + 'admin/'):
            return False
    ...
    MIDDLEWARE_CLASSES = MIDDLEWARE_CLASSES + (
        ...
        'debug_middleware.BKDebugPanelMiddleWare',
    )
    ...
    DEBUG_TOOLBAR_PANELS = [
        ...
        # 'http_client_panel_v1.panels.HttpClient.HttpClientPanel',
    ...
    DEBUG_TOOLBAR_CONFIG = {
        ...
        # 'EXTRA_SIGNALS': ['dev_tools.signals.MySignal'],
        'HIDE_DJANGO_SQL': False,
        'TAG': 'div',
        'DISABLE_PANELS': set(DEBUG_TOOLBAR_PANELS),
        'JQUERY_URL': STATIC_URL + 'assets/jquery-1.10.2.min.js?v=0.18',
    }
